...
A partir des concentrations prédites dans les liquides analysés, nous allons calculé la masse en acide chicorique par masse sèche de tissu de plante pour chaque condition de culture.
créer un facteur de conversion qui transform la concentration dans le liquide analysé (µM) en masse en acide chicorique dans le tissu correspondant (mg)
